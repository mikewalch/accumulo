...
public class Constants {
  ...
  public static final Collection<String> PATH_PROPERTY_ENV_VARS = Collections.unmodifiableCollection(Arrays.asList("ACCUMULO_BIN_DIR", "ACCUMULO_LIB_DIR",
      "ACCUMULO_CONF_DIR", "ACCUMULO_LOG_DIR"));
