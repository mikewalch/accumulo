...
## installation and using directory structure of binary tarball release. Uncomment and
## change variables if you did not install using binary tarball.

# export ACCUMULO_BIN_DIR=/path/to/accumulo/bin
# export ACCUMULO_CONF_DIR=/path/to/accumulo/conf
# export ACCUMULO_LIB_DIR=/path/to/accumulo/lib
# export ACCUMULO_LOG_DIR=/path/to/accumulo/log
# export ACCUMULO_PID_DIR=/path/to/accumulo/run
# export ACCUMULO_OPT_DIR=/path/to/accumulo/opt
